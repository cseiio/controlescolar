  ...
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a>Inscripción Ciclos Anteriores</a>
      </li>
    ...
    <form id="formulario">
      ...
      <p class="text-center text-white rounded titulo-form h4 ">Ciclo Escolar</p>
      <hr>
      <!--------------------------------------------------------------->
        ...
        <div class="row">
          <div class="col-md-12">
            <label class="form-group has-float-label seltitulo">
              <select class="form-control form-control-lg selcolor" id="id_ciclo_escolar" required name="id_ciclo_escolar" required>
